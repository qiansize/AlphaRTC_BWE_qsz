...
def main():
    ...
    ppo2=PPO(state_dim, state_length,action_dim, exploration_param, lr, betas, gamma, K_epochs, ppo_clip)
    # ppo.policy.load_state_dict(torch.load('data/ppo_2021_07_14_16_45_50.pth'))
    # ppo.policy_old.load_state_dict(torch.load('data/ppo_2021_07_14_16_45_50.pth'))
    ...
    ppo2.policy.load_state_dict(torch.load('data/ppo_2021_07_16_18_17_27.pth'))
    utils_ppo.draw_module(config, ppo.policy, ppo2.policy,data_path)
